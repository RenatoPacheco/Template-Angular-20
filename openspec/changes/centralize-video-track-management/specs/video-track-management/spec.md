...
Centraliza o controle das faixas do player para oferecer comportamento consistente e permitir acrescentar novos tipos no futuro, iniciando com legendas, navegação por capítulos e emissão dos cues de metadata.
